...
class OrderApi:
    ...
    def createOrderOld(self, body: OrderRequest) -> dict:
        Auth.checkAuth()
        ...
        if response.status_code == 200:
            print(f"{Color.GREEN}Success: Order created (200).{Color.GRAY}")
        else:
...
if __name__ == "__main__":
    ...
    response = order_api.createOrderOld(body=order_request)
    pprint(response)
