...
# from src.data.datasource.tests_datasource import get_receipt_domain
from src.data.model.calculator_response import CalculatorResponse, Position
from src.data.model.receipt_response import TaxEntry, TaxDetail
